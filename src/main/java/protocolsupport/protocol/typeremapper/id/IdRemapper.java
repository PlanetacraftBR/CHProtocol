				...
				public void setRemap(int from, int to) {
					...
					try {
						...
						if (strengthTo < strengthFrom) {
							CHProtocol.logWarning("Block remapper warning: strength of block " + Material.getMaterial(blockIdTo) + " is less than strength of block with id " +  Material.getMaterial(blockIdFrom));
						}
